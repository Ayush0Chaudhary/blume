...
def main():
    ...
    for i in range(data["no_of_depot"]):
        ...
        # NOTE: Interesting oberservation
        # Objective: 411
        # 0:`
        # 0 -> 0
        # Distance travelled: 0miles
        ...
        # 5:
        # 0 -> 2 -> 3 -> 4 -> 7 -> 1 -> 5 -> 6 -> 0
        # Distance travelled: 411miles

        # For warehouse 1:
        # Distance of the electric vehicle: 411miles
        # Total distance travelled by all vehicles: 411miles
        # Total cost of the all vehicle: $ 24660`


        # NOTE: No consideratio of time window
